...
public interface LoanCalculator {
    ...
    /**
     * Calculate the monthly amount to be paid for a loan of amount on years with the actual interest rate.
     *
     * @param amount loan amount
     * @param years  number years
     * @return Monthly amount.
     */
    double calculateMonthlyAmount(double amount, int years);
}
