...
class LoanCalculatorValidationServiceTest {
    ...
    @InjectMocks
    private LoanCalculatorValidationServiceImpl loanCalculatorValidationServiceMock;

    @Test
    void validateParameters() {
        // Test if the different parts of the validation are called. Bot validation logic itself.
        //  arrange
        LoanCalculatorValidationServiceImpl spy = Mockito.spy(loanCalculatorValidationServiceMock);
    ...
    @ParameterizedTest
    @MethodSource("provideParametersAmount") // Different values for testing the edge cases.
    ...
    @ParameterizedTest
    @MethodSource("provideParametersYears") // Different values for testing the edge cases.
