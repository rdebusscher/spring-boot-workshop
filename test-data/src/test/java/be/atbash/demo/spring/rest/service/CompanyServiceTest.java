...
class CompanyServiceTest {
    ...
    @Spy
    private final CompanyMapperService companyMapperServiceSpy = MapperUtil.getMapper(CompanyMapperService.class);
    ...
    void getAll() {
        ...
        // act
        List<CompanyWithIdDTO> result = companyService.getAll();

        // assert
        Assertions.assertThat(result).isNotNull();
        Assertions.assertThat(result).hasSize(2);
        Assertions.assertThat(result).extracting(CompanyWithIdDTO::id).containsExactly(1L, 2L);
        // we don't need to test all returned values. We have a test for CompanyMapperService.
        Mockito.verify(companyMapperServiceSpy, Mockito.times(2)).asDTOWithId(Mockito.any());
    }
    ...
    void getByName() {
        ...
        // act
        CompanyWithIdDTO result = companyService.getByName("Atbash");
    ...
    void deleteByName() {
        ...
        Mockito.verify(employeeRepositoryMock).deleteAllByCompanyId(company.getId());
    }
