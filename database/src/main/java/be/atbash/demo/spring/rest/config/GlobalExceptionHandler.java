...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    ProblemDetail handleBusinessValidationException(BusinessValidationException e) {
        ...
        problemDetail.setType(URI.create("https://api.atbash.be/errors/business-validation-problem"));
        // URI does not exist on internet but might point to a page with more information
